...
from repository_manager.web.deps import db_session, get_templates
...
@router.get("/jobs", include_in_schema=False, name="job_list")
async def job_list(
...
@router.get("/jobs/{job_id}", include_in_schema=False, name="job_detail")
